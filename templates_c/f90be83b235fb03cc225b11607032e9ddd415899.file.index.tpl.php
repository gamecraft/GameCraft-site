<?php /* Smarty version Smarty-3.1.8, created on 2012-02-27 20:07:29
...
<html>
	...
	<body>
		<div id='nav_wrapper'>
			<div class='container'>
				<div id="email">
					<a class='email' href="mailto:level2@Game-Craft.com"> <img class="email_icon" width='24px' height='14px' src='assets/mail_icon.png' alt="email immage" />level2@Game-Craft.com </a>
				</div>
				<ul id='nav_links'>
					<li class='nav'>
